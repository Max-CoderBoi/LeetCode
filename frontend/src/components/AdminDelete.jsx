...
import { Trash2, AlertCircle, AlertTriangle, Search, Filter, Sparkles } from 'lucide-react';
...
const AdminDelete = () => {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('⚠️ Are you sure you want to delete this problem? This action cannot be undone and will permanently remove all associated data.')) return;
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 to-slate-900 flex justify-center items-center">
        <div className="text-center">
          <div className="relative w-16 h-16 mx-auto mb-4">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-600 to-rose-700 rounded-full opacity-75 blur animate-pulse"></div>
            <div className="relative w-16 h-16 border-4 border-rose-600 border-t-transparent rounded-full animate-spin"></div>
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-800/50 shadow-2xl overflow-hidden mb-6">
          <div className="relative px-8 py-6 border-b border-slate-800/50">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-600 to-rose-700 opacity-10 blur"></div>
            <div className="relative flex items-center gap-3">
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-rose-600 to-rose-700 flex items-center justify-center">
                  <AlertTriangle className="w-6 h-6 text-white" />
                </div>
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-br from-rose-600 to-rose-700 rounded-full flex items-center justify-center">
                  <Sparkles className="w-2.5 h-2.5 text-white" />
                </div>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white">Delete Problems</h1>
                <p className="text-slate-400 mt-1">⚠️ Permanently remove problems from the database</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500/50 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="lg:w-64">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500/50 transition-all appearance-none"
                  >
          ...
          {/* Warning Banner */}
          <div className="bg-rose-500/10 border-t border-rose-500/20 px-6 py-4">
            <div className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-rose-400 flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm text-rose-400 font-medium">
                  <strong>Caution:</strong> Deleting a problem is permanent and cannot be undone. All associated data including submissions, test cases, and statistics will be lost.
                </p>
              </div>
            </div>
          </div>
